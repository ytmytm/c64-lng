...
illfs:	pla
		...
		;; changes:		tmpzp(0,1,2,3,4)	;; C128 also tmpzp(5,6)
		;; changes:		syszp(4,5)
		;; calls: spalloc
		;; calls: int_fddup
		;; calls: p_insert
...
skipadd:
	...
	+	txa
		...
		ldy  #$80				; no I/O (since it is accessed from the kernel,
		jsr  spalloc			; second page for commandline arguments
		bcc  +
...
nostruc:
		ldy  tmpzp+1
		pla						; get address of second allocated page
